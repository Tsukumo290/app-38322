...
### 服の保存
1.フッターにある服アイコンをクリックし、新規登録画面へ遷移します。  
2.新規保存ボタンから、服の詳細（画像・ブランド名・購入金額・カテゴリー・カラー・シーズン・サイズ）を入力し保存することができます。

### メモの作成
1.詳細画面の入力フォームにメモを入力し作成します。

### 着用回数のカウント
1.詳細画面の着用回数をクリックし、カウントを増やします。

### 画像の複数保存
1.フッターにあるメモアイコンからコーディネートページへ遷移します。  
2.中央にあるフォームから保存したい日付と画像を選択することで画像を保存し、カレンダー内の選択された日付に表示することができます。
