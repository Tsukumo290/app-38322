$(document).on('change', '#genre', function() {
  ...
  const select = $('#genre').val();
    ...
    if (select == 5) {
      ...
      $('#season option[value = 5]').css('display', 'block');

      $('#season option[value = 1]').css('display', 'none');
      $('#season option[value = 2]').css('display', 'none');
      $('#season option[value = 3]').css('display', 'none');
      $('#season option[value = 4]').css('display', 'none');
    } else {
      ...
      $('#season option[value = 5]').css('display', 'none');

      $('#season option[value = 1]').css('display', 'block');
      $('#season option[value = 2]').css('display', 'block');
      $('#season option[value = 3]').css('display', 'block');
      $('#season option[value = 4]').css('display', 'block');
    };
});