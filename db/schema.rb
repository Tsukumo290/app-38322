...
ActiveRecord::Schema.define(version: 2022_08_26_190914) do
  ...
  create_table "closets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "memos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["closet_id"], name: "index_memos_on_closet_id"
